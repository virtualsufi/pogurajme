...
/**
 * @OA\Info(title="Poguraj me BizNet API", version="0.2")
 * @OA\OpenApi(
...
/**
 * @OA\Post(path="/accounts", tags={"x-admin", "account"}, security={{"ApiKeyAuth": {}}},
...
/**
 * @OA\Put(path="/accounts/{id}", tags={"x-admin", "account"}, security={{"ApiKeyAuth": {}}},
